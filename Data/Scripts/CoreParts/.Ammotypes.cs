...
{ // Don't edit above this line
    partial class Parts
    {
        ...
        private AmmoDef PriestLrgGatlingTurretAmmo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "25x184mmPriest", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            EnergyMagazineSize = 540, // For energy weapons, how many shots to fire before reloading.
            ...
            {
                AmmoRound = "Frag 25x184mmPriest", // AmmoRound field of the ammo to spawn.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 30f, //
                        Width = 0.25f, //
                        Color = Color(red: 2f, green: 0.4f, blue: 0.3f, alpha: 0.1f), // RBG 255 is Neon Glowing, 100 is Quite Bright.
        ...
        private AmmoDef PriestFakeLrgGatlingTurretAmmo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "25x184mm", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Real Fake 25x184mm BulletPriest", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
                    ...
                    Types = new[] // List of blocks to apply custom damage multipliers to.
    {
        ...
        private AmmoDef PriestLrgGatlingTurretFragment => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Frag 25x184mmPriest", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 0.4f, // Direct damage; one steel plate is worth 100.
            Mass = 0f, // In kilograms; how much force the impact will apply to the target.
